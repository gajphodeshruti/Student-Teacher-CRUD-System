        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-flex justify-content-end mb-4 px-4">
                    <a href="{{ route('students.export', request()->query()) }}" class="btn btn-sm btn-primary shadow-sm">
                        <i class="fas fa-download fa-sm text-white-50"></i> Export to PDF
                    </a>
                    <a href="{{ route('students.export.excel',['search' => request()->input('search'), 'state_id' => request()->input('state_id'), 'university_id' => request()->input('university_id'), 'college_id' => request()->input('college_id')]) }}" class="btn btn-sm btn-primary shadow-sm ms-2">
                        <i class="fas fa-download fa-sm text-white-50"></i> Export to Excel
                    </a>
                    <a href="{{ route('Students.create') }}" class="btn btn-sm btn-primary shadow-sm ms-2">
                        + Create
                    </a>
                </div>
                ...
                <div class="container">
                    ...
                    <form method="GET" action="{{ route('students.index') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <select name="taluka_id" class="form-control form-control-sm" id="taluka">
                                    ...
                                    @foreach($talukas as $taluka)
                                        <option value="{{ $taluka->id }}" {{ request('taluka_id') == $taluka->id ? 'selected' : '' }}>{{ $taluka->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 d-flex align-items-start gap-2">
                                ...
                                <a href="{{ route('auth.index') }}" class="btn btn-secondary btn-sm mt-1">Cancel Filter</a>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="mt-3">
                        <div class="card shadow border-0 p-4">
                            ...
                            <form method="GET" action="{{ route('students.index') }}" action="search">
                                <div class="input-group mb-3">
                                    <input type="text" name="search" value="{{ request('search') }}"
                                        class="form-control form-control-sm" placeholder="Search...">
                                    <button type="submit" class="btn btn-primary btn-sm">Search</button>
                                    <a href="{{ route('auth.index') }}" class="btn btn-secondary btn-sm ml-2">Reset</a>
                                </div>
                            </form>

        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card shadow border-0 p-5">
                    ...
                    <form id="register-form" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <div class="mt-4 text-center">
                    <p>Already have an account? <a href="<?php echo e(route('login.view')); ?>">Login</a></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Crud\resources\views/auth/register.blade.php ENDPATH**/ ?>